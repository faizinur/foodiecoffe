        ...
        <View
            ...
            <View style={{ flex: 1, paddingHorizontal: 15, height: 80 }}>
                ...
                <View style={{ justifyContent: 'space-between', alignItems: 'center', flexDirection: 'row', width: 80, height: 40, }}>
                    <TouchableOpacity activeOpacuty={.9} style={{ width: 24, height: 24, borderRadius: 12, borderWidth: 1, borderColor: colors.wildWaterMelon, justifyContent: 'center', alignItems: 'center' }}>
